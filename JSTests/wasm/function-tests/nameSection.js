...
assert.eq(stacktrace[1], "_eggs@<?>:wasm-function[21]");
assert.eq(stacktrace[2], "_bacon@<?>:wasm-function[22]");
assert.eq(stacktrace[3], "_spam@<?>:wasm-function[23]");
assert.eq(stacktrace[4], "_parrot@<?>:wasm-function[24]");
